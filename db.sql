...
INSERT INTO menu_pages(page_id,tab_id,orderNum,page_path,page_title) VALUE('13', '1', '3', 'contact.kgu', '위치 및 연락처');

INSERT INTO menu_pages(page_id,tab_id,orderNum,page_path,page_title) VALUE('20', '2', '0', 'information.kgu', 'SWAIG 교과목 리스트');
INSERT INTO menu_pages(page_id,tab_id,orderNum,page_path,page_title) VALUE('21', '2', '1', 'information.kgu', 'SWAIG 교과목 개요');
