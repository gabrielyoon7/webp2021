...
<div class="">
    ...
    <table class="boardtable" id="table1" data-toggle="table"
        ...
        <tr>
            ...
            <th data-field="major_name" data-sortable="true">전공/트랙 이름</th>
...
<div class="py-2 d-flex justify-content-end">
    ...
    <button type="button" class="btn btn-success" data-bs-toggle="modal" data-bs-target="#staticBackdrop"
            onclick="makeAddMajorModal()">전공/트랙 추가
    </button>
</div>
<script>
    ...
    function makeAddMajorModal() {
        ...
        modal_body += ''
            ...
            + '</select>'
            + '<div class="my-1">전공/트랙 아이디 (영문/숫자 혼용 가능) </div>'
            + '<input type="text" class="form-control" id="add_major_id" name="new_table" value="" placeholder="전공/트랙 아이디를 입력해주세요(수정 불가능 / 띄어쓰기 금지)">'
            ...
            + '<div class="my-1">전공/트랙 이름</div><input type="text" class="form-control" id="add_major_name" name="new_table" value="" placeholder="전공/트랙 이름을 입력해주세요">'
            + '<div class="my-1">학과위치</div><input type="text" class="form-control" id="add_major_location" name="new_table" value="" placeholder="학과위치를 입력해주세요">'
            + '<div class="my-1">학과연락처</div><input type="text" class="form-control" id="add_major_contact" name="new_table" value="" placeholder="학과연락처를 입력해주세요">';
